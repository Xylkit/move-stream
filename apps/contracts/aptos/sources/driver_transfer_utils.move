...
module xylkit::driver_transfer_utils {
    ...
    public fun set_streams_and_transfer(
        ...
        if (balance_delta > 0) {
            transfer_to_drips(caller, token_type, (balance_delta as u128));
        };
        ...
        if (real_balance_delta < 0) {
            drips::withdraw(token_type, transfer_to, ((0 - real_balance_delta) as u128));
        };
