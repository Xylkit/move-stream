module xylkit::error_handling {
    ...
    const E_SPLITS_INVALID_CURRENT_RECEIVERS: u64 = 210;
    ...
    public fun emit_error_event(
        category: u8, code: u64, message: String, timestamp: u64
    ) {
        event::emit(
            ErrorEvent { category, code, message, timestamp }
        );
    }
    ...
    public fun assert_with_error(
        condition: bool, category: u8, code: u64
    ) {
        if (!condition) {
    ...
    public fun validate_amount(
        amount: u64, category: u8, error_code: u64
    ) {
    ...
    public fun validate_resource_not_exists<T: key>(
        exists: bool,
        category: u8,
        error_code: u64
    ) {
    ...
    // Public accessor functions for categories
    public fun get_category_general(): u8 {
        CATEGORY_GENERAL
    }

    public fun get_category_drips(): u8 {
        CATEGORY_DRIPS
    }

    public fun get_category_splits(): u8 {
        CATEGORY_SPLITS
    }

    public fun get_category_address_driver(): u8 {
        CATEGORY_ADDRESS_DRIVER
    }

    public fun get_category_nft_driver(): u8 {
        CATEGORY_NFT_DRIVER
    }

    public fun get_category_integration(): u8 {
        CATEGORY_INTEGRATION
    }

    // Public accessor functions for error codes
    public fun get_e_unauthorized(): u64 {
        E_UNAUTHORIZED
    }

    public fun get_e_invalid_argument(): u64 {
        E_INVALID_ARGUMENT
    }

    public fun get_e_resource_not_found(): u64 {
        E_RESOURCE_NOT_FOUND
    }

    public fun get_e_resource_already_exists(): u64 {
        E_RESOURCE_ALREADY_EXISTS
    }

    public fun get_e_insufficient_funds(): u64 {
        E_INSUFFICIENT_FUNDS
    }

    public fun get_e_arithmetic_error(): u64 {
        E_ARITHMETIC_ERROR
    }

    public fun get_e_invalid_state(): u64 {
        E_INVALID_STATE
    }

    public fun get_e_operation_not_supported(): u64 {
        E_OPERATION_NOT_SUPPORTED
    }

    public fun get_e_limit_exceeded(): u64 {
        E_LIMIT_EXCEEDED
    }

    // Drips error codes accessors
    public fun get_e_drips_hub_already_exists(): u64 {
        E_DRIPS_HUB_ALREADY_EXISTS
    }

    public fun get_e_drips_hub_not_found(): u64 {
        E_DRIPS_HUB_NOT_FOUND
    }

    public fun get_e_drips_insufficient_balance(): u64 {
        E_DRIPS_INSUFFICIENT_BALANCE
    }

    public fun get_e_drips_invalid_amount(): u64 {
        E_DRIPS_INVALID_AMOUNT
    }

    public fun get_e_drips_invalid_receiver(): u64 {
        E_DRIPS_INVALID_RECEIVER
    }

    public fun get_e_drips_invalid_amt_per_sec(): u64 {
        E_DRIPS_INVALID_AMT_PER_SEC
    }

    public fun get_e_drips_invalid_duration(): u64 {
        E_DRIPS_INVALID_DURATION
    }

    public fun get_e_drips_receivers_not_sorted(): u64 {
        E_DRIPS_RECEIVERS_NOT_SORTED
    }

    public fun get_e_drips_duplicate_receiver(): u64 {
        E_DRIPS_DUPLICATE_RECEIVER
    }

    public fun get_e_drips_invalid_balance_delta(): u64 {
        E_DRIPS_INVALID_BALANCE_DELTA
    }

    public fun get_e_drips_max_cycles_exceeded(): u64 {
        E_DRIPS_MAX_CYCLES_EXCEEDED
    }

    // Splits error codes accessors
    public fun get_e_splits_invalid_weight(): u64 {
        E_SPLITS_INVALID_WEIGHT
    }

    public fun get_e_splits_too_many_receivers(): u64 {
        E_SPLITS_TOO_MANY_RECEIVERS
    }

    public fun get_e_splits_receivers_not_sorted(): u64 {
        E_SPLITS_RECEIVERS_NOT_SORTED
    }

    public fun get_e_splits_weight_sum_too_high(): u64 {
        E_SPLITS_WEIGHT_SUM_TOO_HIGH
    }

    public fun get_e_splits_store_not_found(): u64 {
        E_SPLITS_STORE_NOT_FOUND
    }

    public fun get_e_splits_duplicate_receiver(): u64 {
        E_SPLITS_DUPLICATE_RECEIVER
    }

    public fun get_e_splits_self_receiver_not_allowed(): u64 {
        E_SPLITS_SELF_RECEIVER_NOT_ALLOWED
    }

    public fun get_e_splits_insufficient_balance(): u64 {
        E_SPLITS_INSUFFICIENT_BALANCE
    }

    public fun get_e_splits_invalid_current_receivers(): u64 {
        E_SPLITS_INVALID_CURRENT_RECEIVERS
    }

    // Address driver error codes accessors
    public fun get_e_address_driver_already_exists(): u64 {
        E_ADDRESS_DRIVER_ALREADY_EXISTS
    }

    public fun get_e_address_driver_not_found(): u64 {
        E_ADDRESS_DRIVER_NOT_FOUND
    }

    public fun get_e_address_account_id_already_registered(): u64 {
        E_ADDRESS_ACCOUNT_ID_ALREADY_REGISTERED
    }

    public fun get_e_address_not_registered(): u64 {
        E_ADDRESS_NOT_REGISTERED
    }

    public fun get_e_address_invalid_amount(): u64 {
        E_ADDRESS_INVALID_AMOUNT
    }

    public fun get_e_address_invalid_receiver(): u64 {
        E_ADDRESS_INVALID_RECEIVER
    }

    public fun get_e_address_unauthorized(): u64 {
        E_ADDRESS_UNAUTHORIZED
    }

    // NFT driver error codes accessors
    public fun get_e_nft_token_already_minted(): u64 {
        E_NFT_TOKEN_ALREADY_MINTED
    }

    public fun get_e_nft_not_token_owner(): u64 {
        E_NFT_NOT_TOKEN_OWNER
    }

    public fun get_e_nft_invalid_token_id(): u64 {
        E_NFT_INVALID_TOKEN_ID
    }

    public fun get_e_nft_invalid_amount(): u64 {
        E_NFT_INVALID_AMOUNT
    }

    public fun get_e_nft_invalid_receiver(): u64 {
        E_NFT_INVALID_RECEIVER
    }

    public fun get_e_nft_salt_already_used(): u64 {
        E_NFT_SALT_ALREADY_USED
    }

    public fun get_e_nft_driver_already_exists(): u64 {
        E_NFT_DRIVER_ALREADY_EXISTS
    }

    public fun get_e_nft_driver_not_found(): u64 {
        E_NFT_DRIVER_NOT_FOUND
    }

    public fun get_e_nft_unauthorized(): u64 {
        E_NFT_UNAUTHORIZED
    }
}
